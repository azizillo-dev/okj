...
// Lazy load CreatePostModal for bundle optimization (Requirement 4)
...
export const ClientLayoutShell: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-okj-bg-deep text-okj-text-primary selection:bg-okj-gold selection:text-okj-bg-deep">
